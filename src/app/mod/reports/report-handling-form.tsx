...
export function ReportHandlingForm({ reportId }: { reportId: string }) {
  ...
  return (
    <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className={`rounded-md border px-3 py-1.5 text-xs font-medium ${
                handling === opt.value
                  ...
                  : "border-green-300 hover:bg-green-100 dark:border-stone-700 dark:hover:bg-stone-900"
              }`}
            >
              {opt.label}
            </button>
      ...
      {isBanHandling ? (
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            name="duration_hours"
            defaultValue={72}
            className="w-40 rounded-md border border-green-300 px-2 py-1.5 text-sm dark:border-stone-700 dark:bg-stone-950"
          >
      ...
      {handling !== null ? (
        <div className="flex flex-wrap gap-2 border-t border-green-200 pt-4 dark:border-stone-800">
          ...
          <form action={escalateReportSimple}>
            ...
            <button
              type="submit"
              className="rounded-md border border-green-300 px-4 py-2 text-sm font-medium hover:bg-green-100 dark:border-stone-700 dark:hover:bg-stone-900"
            >
              Escalate to Admin
            </button>
          </form>
