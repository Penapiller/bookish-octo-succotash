...
import { sendStaffTicketReply, type StaffTicketReplyState } from "../actions";

const initialState: StaffTicketReplyState = null;

export function StaffReplyForm({ ticketId }: { ticketId: string }) {
  const [state, formAction, isPending] = useActionState(sendStaffTicketReply, initialState);
